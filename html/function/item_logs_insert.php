...
if(isset($_POST['button'])){
	...
	$query = "SELECT student_STUDENT_ID FROM logs WHERE student_STUDENT_ID = '". $student_student_id ."' AND Time_IN IS NOT NULL";
...
<div id="extra">
					  <table id="item_form">
							  	...
							  	<tr>
							  		...
							  		<td>
								  		<input type="submit" name="submit2" id="stud_insert" style="width: 250px;">				
									</td>
							  	</tr>
							</table>
					</div>